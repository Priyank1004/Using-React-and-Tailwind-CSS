...
import Single from '../assest/single.png';
import Double from '../assest/double.png';
import Triple from '../assest/triple.png';

const Plans = () => {
    return (
        <div className='py-[100px] px-6'>
            <div className='max-w-[1240px] mx-auto md:grid grid-cols-3 gap-8'>
                <div className='shadow-xl p-4 my-12 rounded-lg hover:scale-105 duration-300 text-center'>
                ...
                <div className='shadow-xl p-4 my-12 rounded-lg bg-gray-100 hover:scale-105 duration-300 text-center'>
